...
class Solver:
    ...
    def MinimumInsertions(self):
        ...
        closest25points = sorted(range(1, len(distFrombase)), key=lambda k: distFrombase[k])[:25]
        j = 1
        insPos = 0
        for i in closest25points:
            ...
            randomInsertion.route = self.sol.routes[closest25points.index(i)]
